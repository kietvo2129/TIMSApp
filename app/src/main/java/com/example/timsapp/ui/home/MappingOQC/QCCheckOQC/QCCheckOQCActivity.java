package com.example.timsapp.ui.home.MappingOQC.QCCheckOQC;
...
public class QCCheckOQCActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog = new ProgressDialog(QCCheckOQCActivity.this, R.style.AlertDialogCustom);
        ...
        tv_qcheck_checkqty.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (tv_qcheck_checkqty.getText().length() > 0) {
                    ck[0] = Integer.parseInt(tv_qcheck_checkqty.getText().toString().trim());
                    if (Integer.parseInt(tv_qcheck_checkqty.getText().toString()) > numgr_qty) {
                        tv_qcheck_checkqty.setError("less than or equal \"" + numgr_qty + "\"");
                        tv_qcheck_checkqty.setText("" + numgr_qty);
                    }
                } else {
                    ck[0] = 0;
    ...
    private void pp_detail() {
        filterDialog = new Dialog(QCCheckOQCActivity.this, R.style.Theme_AppCompat_DayNight_Dialog_Alert);
        filterDialog.setContentView(R.layout.popup_detail_qc_check);
        filterDialog.setCancelable(false);
        filterDialog.getWindow().setLayout(getWidth(QCCheckOQCActivity.this), ((getHight(QCCheckOQCActivity.this) / 100) * 90));
        ...
        protected void onPostExecute(String s) {
            ...
            try{
                ...
                if (jsonArray.length()==0){
                    dialog.dismiss();
                    AlerError.Baoloi("No data", QCCheckOQCActivity.this);
                    return;
                }
                ...
                e.printStackTrace();
                dialog.dismiss();
                AlerError.Baoloi("Could not connect to server", QCCheckOQCActivity.this);
            }
    ...
    private void builryc() {
        ...
        mLayoutManager = new LinearLayoutManager(QCCheckOQCActivity.this);
    ...
    private void buildQCMake() {
        ...
        recyclerViewCHECK.setLayoutManager(new LinearLayoutManager(QCCheckOQCActivity.this));
        ...
        adapterLess.setOnItemClickListener(new QcCheckerLessAdaptor.OnItemClickListener() {
            ...
            public void onItemButtonUp(int position) {
                ...
                if (valDefect <= Tong) {
                    ...
                    // Toast.makeText(QCCheckOQCActivity.this, "Defect qty max value: \"" + valDefect + "\"", Toast.LENGTH_SHORT).show();
                    return;
    ...
    private void inputNumberDialog(final int posi) {
        ...
        Window window = QCCheckOQCActivity.this.getWindow();
        window.getDecorView().getWindowVisibleDisplayFrame(displayRectangle);
        final AlertDialog.Builder builder = new AlertDialog.Builder(QCCheckOQCActivity.this, R.style.Theme_AppCompat_DayNight_Dialog_Alert);
        builder.setTitle("Qty Value");
        View dialogView = LayoutInflater.from(QCCheckOQCActivity.this).inflate(R.layout.number_input_layout_ok_cancel, null);
        ...
        protected void onPostExecute(String s) {
            ...
            try{
                ...
                if (!jsonObject.getBoolean("result")){
                    dialog.dismiss();
                    AlerError.Baoloi(jsonObject.getString("message"), QCCheckOQCActivity.this);
                }else {
                    dialog.dismiss();
                    Toast.makeText(QCCheckOQCActivity.this, "Check QC Done", Toast.LENGTH_SHORT).show();
                    finish();
                }
