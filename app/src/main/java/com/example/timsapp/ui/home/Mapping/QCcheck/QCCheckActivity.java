...
public class QCCheckActivity extends AppCompatActivity {
    ...
    int numgr_qty = MappingDetailActivity.numgr_qty;
        ...
        protected void onPostExecute(String s) {
            ...
            try{
                ...
                if (jsonArray.length()==0){
                    dialog.dismiss();
                    AlerError.Baoloi("No data", QCCheckActivity.this);
                    return;
                }
        ...
        protected void onPostExecute(String s) {
            ...
            try{
                ...
                if (!jsonObject.getBoolean("result")){
                    dialog.dismiss();
                    AlerError.Baoloi(jsonObject.getString("message"), QCCheckActivity.this);
                }else {
                    dialog.dismiss();
                    Toast.makeText(QCCheckActivity.this, "Check QC Done", Toast.LENGTH_SHORT).show();
                    finish();
                }
