...
public class DivideMaster {
    String no,wmtid,date,mt_cd,mt_no,bbmp_sts_cd,mt_qrcode,lct_cd,bb_no,mt_barcode;
    int gr_qty,gr_qty1,cnt,sl_tru_ng;

    public DivideMaster(String no, String wmtid, String date, String mt_cd, String mt_no, String bbmp_sts_cd, String mt_qrcode, String lct_cd, String bb_no, String mt_barcode, int gr_qty, int gr_qty1, int cnt, int sl_tru_ng) {
        this.no = no;
        this.wmtid = wmtid;
        this.date = date;
        this.mt_cd = mt_cd;
